...
Un cable eléctrico de potencia es un sistema multicapa compuesto por un conductor y por capas funcionales de aislamiento, pantallas y protección. Durante la operación, la corriente que circula por el conductor genera calor, principalmente por pérdidas debidas al efecto Joule, y este calor se transfiere hacia los materiales del entorno \parencites[1--3]{enescu2020}{iec60502_2_2014}. La \emph{ampacidad} \(\Imax\) es la máxima corriente que puede circular de manera continua sin que el conductor supere su temperatura admisible \parencites[752]{neher1957}[1]{enescu2020}.

En los sistemas eléctricos, los cables subterráneos permiten transportar energía cuando existen restricciones de espacio, seguridad, servidumbre o integración con otras infraestructuras \parencite{cigre2020tb815}. En una instalación enterrada pueden disponerse, por ejemplo, en configuración plana o en trébol, y el entorno que recibe el calor comprende el material de asiento, los rellenos de mejora térmica, la zanja y el suelo nativo \parencites{enescu2021}{ieee442}{kim2025}. Por ello, el objeto físico de esta investigación es el \emph{arreglo de cables--entorno térmico}: el conjunto formado por los cables, su disposición geométrica y los materiales circundantes que intervienen en la generación y evacuación del calor \parencites[1--3]{enescu2020}[41--42]{cigre2025}.

El entorno se considera \emph{térmicamente heterogéneo} cuando sus propiedades de transferencia de calor varían con la posición debido, entre otros factores, a la humedad, los estratos, los rellenos o las interfaces entre materiales \parencites[3--4]{enescu2021}[1,6--7]{khumalo2025}[1--3]{aldulaimi2024}. Esta variación se representa mediante la conductividad térmica espacial \(\kx\), propiedad que expresa la capacidad local de un material para conducir calor. La respuesta del sistema se describe mediante el campo de temperatura \(T(x,y)\), es decir, la temperatura asignada a cada punto del dominio, del cual se obtiene la temperatura máxima de los conductores \(\Tmax\) \parencites[3--4]{enescu2021}[3]{xing2023}.

Estas entidades se relacionan mediante una secuencia física: la corriente genera pérdidas en los cables; el arreglo y la conductividad del entorno determinan la evacuación del calor; y el campo resultante permite comprobar si \(\Tmax\) respeta el límite empleado para calcular \(\Imax\) \parencites[752--753]{neher1957}[1--4]{enescu2021}. Sin embargo, representar el terreno mediante propiedades homogéneas o equivalentes puede ocultar variaciones relevantes, mientras que una descripción numérica detallada exige preparar y recalcular cada configuración \parencites[41--42,93--99]{cigre2025}[1--3,12]{aldulaimi2024}.

En el plano práctico, una representación insuficiente de la heterogeneidad puede producir una estimación insegura de la capacidad térmica o, en sentido contrario, excesivamente conservadora. En el plano del conocimiento, todavía se requiere establecer cuándo y en qué magnitud esa heterogeneidad modifica \(T(x,y)\), \(\Tmax\) e \(\Imax\) respecto de una representación homogénea equivalente \parencites[4--6]{enescu2021}[3--4,93--99]{cigre2025}.

Para abordar este vacío de conocimiento se propone una \emph{red neuronal informada por física} (PINN), entendida como una red neuronal cuyo aprendizaje incorpora en la función de pérdida la ecuación diferencial gobernante y sus condiciones de frontera e interfaz. La PINN actúa como un aproximador continuo de \(T(x,y)\) y penaliza las soluciones que incumplen la física del problema \parencite{raissi2019}. El artefacto computacional integra esta red con la representación de \(\kx\), los datos del arreglo y los procedimientos para estimar \(\Tmax\) e \(\Imax\); su evaluación determinará su pertinencia y sus limitaciones, sin asumir que reemplaza o supera los métodos existentes.

El estudio se organiza bajo la ciencia del diseño (DSR), paradigma que guía la construcción y evaluación rigurosa de artefactos destinados a resolver problemas identificados \parencites[55--56]{peffers2007}[342--344]{gregor2013}. Sobre esta base, la investigación relaciona la situación práctica y sus consecuencias con el problema subyacente ---el vacío de conocimiento--- y con el problema técnico que orienta el diseño y la evaluación del artefacto.

\section{PROBLEMÁTICA}

Las redes eléctricas atraviesan una etapa de mayor exigencia operativa porque la generación, la demanda y la participación de la generación renovable, particularmente solar y eólica, siguen aumentando. En América Latina y el Caribe, la generación eléctrica creció 5,5\,\pct{} en 2024 y la renovabilidad regional alcanzó 69\,\pct{}; además, la energía solar llegó a 7\,\pct{} de la matriz \parencite{olade2025generacionALC2024}. En el Perú, la producción eléctrica nacional creció a una tasa media anual de 2,4\,\pct{} entre 2023 y 2025, mientras que la máxima demanda del SEIN aumentó 2,2\,\pct{} anual en el mismo periodo, según las cifras del MINEM y el COES \parencites{minem2025anuario2024}{minem2025indicadoresDiciembre}{coesMaximaDemanda}.

La presión sobre la red también proviene del cambio en la matriz. En el Perú, la participación conjunta de la generación solar y eólica pasó de un valor cercano a cero en 2010 a 5,3\,\pct{} en 2023, 8,1\,\pct{} en 2024 y 9,5\,\pct{} en 2025. Estos porcentajes se calcularon con la serie del MINEM y, para 2025, emplean cifras preliminares \parencites[sec.~10.4]{minem2025anuario2024}[cuadro~4]{minem2025indicadoresDiciembre}. La tendencia coincide con los proyectos de generación eficiente considerados por el COES y con la necesidad de ampliar la red al ritmo de las renovables señalada por la IEA \parencites{coes2023diagnostico2025_2034}{iea2025transmissiongrid}.

La Figura~\ref{fig:participacion-renovable-peru} muestra la evolución de la participación conjunta de ambas fuentes, calculada con datos del MINEM \parencites{minem2025anuario2024}{minem2025indicadoresDiciembre}. Aunque el indicador no mide congestión ni sobrecarga, presenta un contexto que exige planificar las conexiones y aprovechar con criterio la capacidad de transporte \parencites {coes2023diagnostico2025_2034} {iea2025transmissiongrid}. La participación aumentó gradualmente hasta 2023 y se aceleró durante 2024--2025, con un incremento de 4,2 puntos porcentuales respecto de 2023 \parencites{minem2025anuario2024}{minem2025indicadoresDiciembre}. Este crecimiento no implica una exigencia uniforme en toda la red, pero respalda la necesidad de ampliar la infraestructura y evaluar los márgenes de operación \parencites{coes2023diagnostico2025_2034}{iea2025transmissiongrid}.
...
En este contexto, los cables subterráneos se vuelven más relevantes en las redes colectoras de media tensión de las plantas eólicas y solares, así como en los tramos donde las redes enfrentan restricciones de espacio, servidumbre, seguridad, integración urbana, cruces o conexión de instalaciones \parencite{cigre2020tb815}. Por estas razones, su uso eficiente exige estimar con cuidado la ampacidad, porque la capacidad disponible depende del balance térmico con el entorno enterrado y de sus condiciones reales \parencites{fariz2026}{mobius2025}.

La dificultad física surge porque la ampacidad no depende solo del área de la sección transversal de cada conductor ni de las características constructivas de los cables. También depende de la forma en que el calor generado se disipa a través del arreglo hacia el suelo circundante, los rellenos y las capas de material que componen su entorno térmico. Por ello, la respuesta corresponde al objeto completo: el arreglo de cables--entorno térmico. Los métodos clásicos y las normas de cálculo son necesarios como base de ingeniería, pero suelen representar el entorno mediante resistencias térmicas equivalentes para simplificar el cálculo \parencites[752--760]{neher1957}{iec60287}{iec60853}.

Esa representación puede ser débil cuando el terreno real no se comporta como un medio homogéneo. La humedad, los estratos, el material de asiento, el relleno térmico, la profundidad y las zonas secas pueden modificar la conductividad térmica alrededor del cable \parencites[4--6]{enescu2021}[1--3]{aldulaimi2024}. En consecuencia, dos instalaciones con la misma corriente y los mismos cables pueden alcanzar temperaturas distintas si sus entornos enterrados tienen propiedades térmicas diferentes.
