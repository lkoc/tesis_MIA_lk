...
En un caso simulado sin ubicación geográfica reportada, \textcite[15--16]{atoccsa2024} analizaron tres cables unipolares XLPE de \SI{220}{\kilo\volt} y \SI{2000}{\milli\metre\squared}, dispuestos horizontalmente dentro de un relleno con mejora térmica. Estimaron que elevar la resistividad del suelo de \SI{2.5}{\kelvin\metre\per\watt} a \SI{3.0}{\kelvin\metre\per\watt} redujo la ampacidad de \SI{1157}{\ampere} a \SI{1064}{\ampere}. 

Por último, \textcite[12--16]{kim2025} modelaron en Corea del Sur un banco de seis cables XLPE de \SI{154}{\kilo\volt}, con conductores de cobre de \SI{1200}{\milli\metre\squared}, y compararon el uso de PAC ($k=\SI{2.1}{\watt\per\metre\per\kelvin}$) con arena natural ($k=\SI{1.4}{\watt\per\metre\per\kelvin}$). El PAC elevó la ampacidad de aproximadamente \SI{941}{\ampere} a \SI{988}{\ampere} y, a igual corriente, redujo la temperatura máxima de \SI{78}{\celsius} a \SI{71}{\celsius}. La Figura~\ref{fig:resistividad-ampacidad-casos} reúne los cuatro casos.
