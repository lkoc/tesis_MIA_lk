...
\addbibresource{02_referencias_plan_tesis.bib}
...
\vspace{0.4cm}
\includegraphics[width=7.5cm]{02_logo_UNI.png}
...
Los problemas específicos descomponen la brecha general en cuatro necesidades relacionadas: especificar la representación física del objeto, disponer de referencias de verificación, evaluar escenarios heterogéneos controlados y determinar su efecto sobre la ampacidad. Esta articulación evita tratar cada problema de forma aislada y establece la secuencia lógica sintetizada en la Figura~\ref{fig:articulacion-problemas-especificos}. La sistematización posterior de la evidencia y la formulación de principios de diseño no constituyen un problema específico adicional; corresponden a las actividades de evaluación, síntesis y comunicación propias de DSR, descritas en la Sección~\ref{sec:metodologia}.
...
\begin{enumerate}[label=HE\arabic*.]
  ...
  \item La especificación trazable, combinada con referencias válidas analíticas, manufacturadas, FEM convergentes o publicadas, permitirá producir un artefacto aceptado dentro del dominio de verificación, con error relativo de $\Tmax$ no mayor a 5\,\pct{}, NRMSE no mayor a 5\,\pct{}, desequilibrio energético no mayor a 2\,\pct{} y variabilidad entre semillas menor que el efecto térmico mínimo establecido como relevante en el piloto.
...
\begin{table}[H]
\centering
\caption{Variables discretas de entrada y salida, composición y estados por etapa de construcción del artefacto.}
...
\begin{figure}[htbp]
\centering
\includegraphics[height=0.27\textheight,keepaspectratio]{02_kim2025_cable_xsection}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.97\textwidth,height=6.8cm,keepaspectratio]{02_enescu_trench_xsection_es}
...
L{3.40cm}
L{3.40cm}}
\caption{Matriz de consistencia del plan de tesis: entradas discretas, salidas, hipótesis, indicadores y parámetros de caso.}
...
\caption{Diseño discreto de casos y parámetros físicos de cobertura.}
