...
La tesis profesionalizante no plantea una contrastación estadística de hipótesis. Las proposiciones formuladas durante el plan se conservan como criterios previos de calidad, utilidad y efecto físico en la metodología y en el Capítulo~\ref{ch:propuesta-desarrollo}. Esta adaptación vincula las conclusiones con la evidencia computacional y con los límites observados.
