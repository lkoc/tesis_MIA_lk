...
Las PINN emplean usualmente redes neuronales de propagación hacia adelante (\textit{feed-forward}) totalmente conectadas, de tipo perceptrón multicapa \parencite[3--4]{xing2023}. En formulaciones con descomposición del dominio, pueden utilizarse varias redes de este tipo, una por subdominio, acopladas mediante condiciones de interfaz \parencite[4--6]{shukla2021}. Por tanto, la conectividad total describe la arquitectura interna de cada red, mientras que el acoplamiento por subdominios describe la organización de las subredes. El carácter informado por física proviene de incorporar las ecuaciones gobernantes y las condiciones auxiliares en el entrenamiento; no implica una arquitectura recurrente.
