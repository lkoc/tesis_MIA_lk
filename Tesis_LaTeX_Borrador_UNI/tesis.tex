...
\setmainfont{Arial}
\setsansfont{Arial}
% Fuente distribuida con licencia OFL para la línea institucional de la guía.
\newfontfamily\poppins[Path=fonts/,BoldFont=Poppins-Bold.ttf]{Poppins-Bold.ttf}
...
\input{capitulos/00_dedicatoria}
\input{capitulos/00_agradecimientos}
\input{capitulos/00_copia_documentos}
...
\input{capitulos/00_resumen_abstract}
\input{capitulos/00_introduccion}

\clearpage
\pagenumbering{arabic}

\include{capitulos/01_planteamiento_del_problema}
\include{capitulos/02_marco_teorico}
\include{capitulos/03_propuesta_y_desarrollo}
\include{capitulos/04_conclusiones_y_recomendaciones}
