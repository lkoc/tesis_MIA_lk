...
def main():
    ...
    if args.sampling!='fixed' and (args.candidate_multiplier<1 or any(s<=0 or s>=args.adam for s in args.adapt_steps)):raise ValueError('Adaptive steps must lie inside the Adam phase')
