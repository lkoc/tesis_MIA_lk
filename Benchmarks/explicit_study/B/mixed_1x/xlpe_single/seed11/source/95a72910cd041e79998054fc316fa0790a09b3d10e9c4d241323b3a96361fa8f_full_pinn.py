...
class PhysicsLoss:
    ...
    def __init__(self,model,n=512,n_layer=256,n_interface=128,seed=11,sampling='mixed'):
...
def train(domain,config,output):
    ...
    objective=PhysicsLoss(model,config.get('n',512),config.get('n_layer',256),config.get('n_interface',128),config.get('sampling_seed',seed),config.get('sampling','mixed'))
